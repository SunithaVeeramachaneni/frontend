...
server {
    ...
    location /wiapi {
        proxy_pass http://wi-development:8001;#whatever port your app run
    ...
    location /wiapi/appmetrics-dash {
        proxy_pass http://wi-development:8001/appmetrics-dash;#whatever port your app run
        proxy_http_version 1.1;
        proxy_set_header Upgrade $http_upgrade;
        proxy_set_header Connection 'upgrade';
        proxy_set_header Host $host;
    ...
    location /wiabapapi {
        proxy_pass http://wi-abap-development:8002;#whatever port your app run
        proxy_http_version 1.1;
        proxy_set_header Upgrade $http_upgrade;
        proxy_set_header Connection 'upgrade';
        proxy_set_header Host $host;
    ...
    location /wiabapapi/appmetrics-dash {
        proxy_pass http://wi-abap-development:8002/appmetrics-dash;#whatever port your app run
        proxy_http_version 1.1;
        proxy_set_header Upgrade $http_upgrade;
        proxy_set_header Connection 'upgrade';
        proxy_set_header Host $host;
    ...
    location /mccspccabapapi {
        proxy_pass http://mcc-spcc-abap-development:8003;#whatever port your app run
        proxy_http_version 1.1;
        proxy_set_header Upgrade $http_upgrade;
        proxy_set_header Connection 'upgrade';
        proxy_set_header Host $host;
    ...
    location /mccspccabapapi/appmetrics-dash {
        proxy_pass http://mcc-spcc-abap-development:8003/appmetrics-dash;#whatever port your app run
        proxy_http_version 1.1;
        proxy_set_header Upgrade $http_upgrade;
        proxy_set_header Connection 'upgrade';
        proxy_set_header Host $host;
    ...
    location /dashboardapi {
        proxy_pass http://dashboard-development:8004;
        proxy_http_version 1.1;
        proxy_set_header Upgrade $http_upgrade;
        proxy_set_header Connection 'upgrade';
        proxy_set_header Host $host;
    ...
    location /dashboardapi/appmetrics-dash {
        proxy_pass http://dashboard-development:8004/appmetrics-dash;
        proxy_http_version 1.1;
        proxy_set_header Upgrade $http_upgrade;
        proxy_set_header Connection 'upgrade';
        proxy_set_header Host $host;
    ...
    location /masterconfigapi/ {
        proxy_pass http://user-service-development:8009/;
        proxy_http_version 1.1;
        proxy_set_header Upgrade $http_upgrade;
        proxy_set_header Connection 'upgrade';
        proxy_set_header Host $host;
