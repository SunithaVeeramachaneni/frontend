...
export class AddWorkinstructionComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public titleProvided: boolean = false;
  public receivedInstruction: boolean = false;
  public saveStatus = '';
  public beforeSaveMessage: boolean = false;
  public afterSaveMessage: boolean = true;
  public saveddata: boolean = false;
  public publisheddata: boolean = false;
  public setCategory = false;
  isWIPublished = false;
  titleTextChanged = new Subject<string>();
  titleErrors: any = {exists: false, required: false};
  addOrUpdateTitle: boolean = false;
  ...
  ngOnInit(): void {
    ...
    this._commonSvc.minimizeSidebar(true);
    this.stepDetailsSaveSubscription = this._commonSvc.stepDetailsSaveAction$.subscribe(
      data => {
  ...
  publishInstruction(el) {
    ...
    Swal.fire({
      title: 'Are you sure?',
      html: "Work Instruction <strong>" + "'" + el.WI_Name + "'" + "</strong> gets Published",
      icon: 'warning',
        ...
        this.publishInstructionSubscription = this._instructionsvc.publishInstruction({
          ...
          () => {
            ...
            this._toastService.show({
              text: 'Work Instruction is successfully published!',
              type: 'success'
            });
            if (favFlag) {
