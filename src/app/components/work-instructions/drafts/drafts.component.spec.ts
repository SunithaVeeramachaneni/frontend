...
describe('DraftsComponent', () => {
  ...
  beforeEach(
    waitForAsync(() => {
      ...
      TestBed.configureTestingModule({
        declarations: [DraftsComponent, DropDownFilterPipe, TimeAgoPipe],
        imports: [
          NgxPaginationModule,
          OrderModule,
          Ng2SearchPipeModule,
  ...
  describe('template', () => {
    ...
    it('should contain labels related to drafts', () => {
      ...
      expect(
        draftsEl.querySelector('#inputSearch').getAttribute('placeholder')
      ).toContain('Search by title or author');
      const searchInfo = draftsEl.querySelector('.author-dropdown');
      ...
      const [draft1] = drafts;
      expect(
        draftsEl.querySelector('table tbody tr th img').getAttribute('src')
      ...
      expect(draftsEl.querySelectorAll('app-dummy').length).toBe(1);
    ...
    it('should display drafts template if current route url is drafts or drafts search', () => {
      expect(draftsEl.querySelector('.drafts-main').childNodes.length).not.toBe(
        0
      );
      ...
      ).and.returnValue(of('/work-instructions/drafts?search=test'));
  ...
  describe('setFav', () => {
    ...
    it('should set work instruction as favorite', () => {
      ...
      component.drafts$.subscribe((data) =>
