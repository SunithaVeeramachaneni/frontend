...
describe('ChatsComponent', () => {
  ...
  describe('ngOnInit()', () => {
    ...
    it('!conversationExists - slack', () => {
      chatServiceSpy.getConversations$ = jasmine
        .createSpy()
        .and.returnValue(convNotExist);

      const updateConversationSpy = spyOn(
    ...
    xit('!conversationExists - msteams', () => {
    ...
    xit('conversation unreadCount is 0', () => {
      chatServiceSpy.getConversations$ = jasmine
        .createSpy()
        .and.returnValue(conversationsMock);
  ...
  describe('addPeopleToConversation', () => {
    it('chatType=oneOnOne', () => {
      const conversation = {
        id: '1',
        userInfo: {},
        chatType: 'oneOnOne',
  ...
  describe('loadMoreConversations', () => {
    it('appendingConversations=true', () => {
    ...
    it('appendingConversations=false & conversationsSkipToken exists', () => {
  ...
  describe('onConversationsListScrolled', () => {
  ...
  describe('onConversationHistoryScrolled', () => {
    it('isTopReached', () => {
    ...
    it('conversationHistorySkipToken is undefined', () => {
      const tSpy = spyOn(component, 'fetchConversationHistory');
      const event = {
        target: {
          scrollHeight: 120,
  ...
  describe('onMessageEnter', () => {
    ...
    it('invalid message with spaces', () => {
      const targetUser = { email: 'testuser@cbo.com' };
      const message = '    ';
      const tSpy = spyOn(component, 'sendMessageToUser');
      component.onMessageEnter(targetUser, message);
  ...
  describe('openAudioVideoCallDialog', () => {
    it('avConfWindowStatus - isOpen=true', () => {
    ...
    xit('avConfWindowStatus - isOpen=false', () => {
      const conferenceType = 'audio';
      chatServiceSpy.getAVConfWindowStatus = jasmine
        .createSpy()
  ...
  describe('removeAttachment', () => {
    it('file does not exist', () => {
      ...
      expect(component.uploadedFiles.length).toEqual(2);
    });
